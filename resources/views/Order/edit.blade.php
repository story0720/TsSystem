                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="date" value="2022-12-31" name="Materialdate" class="form-control" placeholder="請輸入發料日期..." />
                            </div>
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="date" value="2022-12-31" name="Shipdate" class="form-control" placeholder="請輸入出貨日期..." />
                            </div>
                            <div class="form-group col-md-6">
                                <label for=""><span class="text-danger">*</span>應交數量</label>
                                <input type="number" name="Estimatedquantity" class="form-control" id="" min="0" value="0" placeholder="請輸入應交數量...">
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="Unitprice" class="form-control" id="Unitprice" min="0" placeholder="請輸入金額(成品單價)...">
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="">小計</label>
                                <div class="input-group">
                                    ...
                                    <input type="number" name="Count" class="form-control text-danger" id="Count" min="0" value="0" placeholder="系統自動計算（公式：單價 × 應交數量）">
                                </div>
                            </div>
                        </div>
                    </div>
