                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control" data-type="name" name="coname" id="">
                                        ...
                                        @foreach ($consume as $key)
                                            <option value="{{ $key->id }}"
                                                @if ($edit->consume_id == $key->id) selected @endif>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="unitprice" value="{{ $edit->re_unitprice }}"
                                            class="form-control" id="UnitPrice" oninput="countall()"
                                            placeholder="請輸入進貨單價...">
                                    </div>
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" value="{{ $edit->re_quantity }}"
                                            name="quantity" id="" min="1" placeholder="請輸入進貨數量..."
                                            oninput="countall()">
                                    </div>
                                </div>
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="count" value="{{ $edit->re_count }}"
                                            class="form-control text-danger" id="count" min="1"
