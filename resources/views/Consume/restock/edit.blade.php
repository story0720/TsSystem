                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" data-type="name" name="coname" id="">
                                    ...
                                    <option value="{{ $key->id }}" @if($edit->consume_id==$key->id) selected @endif>{{ $key->co_standardName }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" name="caname" id="">
                                    ...
                                    <option value="{{ $key->ca_id }}" @if($edit->factorycategory_id==$key->ca_id) selected @endif>{{ $key->ca_Name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group col-md-6">
