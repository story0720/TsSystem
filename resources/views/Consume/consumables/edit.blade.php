                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col">
                                ...
                                <input type="text" class="form-control" data-type="name" name="standardname" value="{{ $edit['co_standardName'] }}" placeholder="請輸入耗材名稱...">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <div class="mt-2" id="consumables-specification-list">
                                    ...
                                    <div class="consumables-specification-item alert alert-info d-inline-flex mb-0 mr-1 p-0">
...
@endsection
@section('script')
<script src="{{ asset('js/Consume/consumables/edit.js') }}"></script>
@endsection